...
class MovieDetailsFragment : Fragment(), MovieDetailsContract.View {
    ...
    override fun onGetReviewSuccess(reviews: List<Review>) = reviewsAdapter.setReviewList(reviews)

    override fun onGetReviewFailure() =
        Toast.makeText(this.context, "Getting review failed", Toast.LENGTH_SHORT).show()
}