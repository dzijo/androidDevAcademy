...
class ChangePriorityFragmentDialog : DialogFragment() {
    ...
    private fun initListeners() {
        changePriorityLow.setOnClickListener { changePriority(1) }
        changePriorityMedium.setOnClickListener { changePriority(2) }
        changePriorityHigh.setOnClickListener { changePriority(3) }
    }
