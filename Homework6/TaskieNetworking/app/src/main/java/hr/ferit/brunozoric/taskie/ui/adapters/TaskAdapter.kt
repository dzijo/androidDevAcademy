...
class TaskAdapter(
    private val onItemSelected: (BackendTask) -> Unit,
    private val onLongClick: (BackendTask) -> Boolean
) : Adapter<TaskHolder>() {
    ...
    override fun onBindViewHolder(holder: TaskHolder, position: Int) {
        holder.bindData(data[position], onItemSelected, onLongClick)
    }
...
//        data.removeIf { it.id.equals(taskId) }
//    }
}
